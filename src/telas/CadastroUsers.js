  ...
  return (
    <View style={isLargeScreen ? styles.card : styles.formMobile}>
      ...
      <Input
        ...
        placeholder="Exemplar@gmail.com"
        value={email}
      ...
      <Input
        ...
        onBlur={() => {
          if (!verificarMaioridade(ano)) {
            Alert.alert('Atenção', 'Você precisa ter mais de 18 anos para se cadastrar.');
            setAno('');
          }
        }}
        ref={anoRef}
      ...
      >
        <View style={[styles.container, isLargeScreen && styles.containerRow]}>
          ...
          <View style={styles.formContainer}>
            ...
            <Text style={[style.texto, styles.subtitulo]}>Que tal começar uma nova jornada?</Text>
